...
module.exports = function (componentName) { return __awaiter(void 0, void 0, void 0, function () {
    var defaultDir, allFiles;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                defaultDir = componentName;
                if (!fs.existsSync(defaultDir)) {
                    fs.mkdirSync(defaultDir);
                }
                return [4 /*yield*/, fileEnum(componentName)];
            case 1:
                allFiles = _a.sent();
