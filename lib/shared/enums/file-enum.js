...
var fileProjectBabelRC = require("../files/project/babelrc");
var fileProjectEditorConfig = require("../files/project/editorconfig");
var fileProjectEnv = require("../files/project/env");
var fileProjectESLintIgnore = require("../files/project/eslintignore");
var fileProjectESLintRC = require("../files/project/eslintrc");
...
var fileProjectPrettier = require("../files/project/prettierrc");
...
var fileProjectSrcAppSass = require("../files/project/src/app/app.scss");
var fileProjectSrcAppTemplate = require("../files/project/src/app/template");
var fileProjectSrcStyleCommon = require("../files/project/src/assets/styles/common");
var fileProjectSrcStyleIndex = require("../files/project/src/assets/styles/index");
var fileProjectSrcStyleMixins = require("../files/project/src/assets/styles/mixins");
var fileProjectSrcStyleVariables = require("../files/project/src/assets/styles/variables");
module.exports = function (customFileName, fileAuthor, fileDescription) { return __awaiter(void 0, void 0, void 0, function () {
    var componentEnum, projectEnum, projectSrcEnum, projectSrcAppEnum, projectConfigEnum, projectStyleEnum;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                ...
                return [4 /*yield*/, getProjectSrcAppEnum(customFileName, fileAuthor, fileDescription)];
            case 4:
                projectSrcAppEnum = _a.sent();
            ...
            case 6:
                ...
                return [2 /*return*/, Object.assign(componentEnum, projectEnum, projectSrcEnum, projectConfigEnum, projectSrcAppEnum, projectStyleEnum)];
        }
    });
}); };
...
function getProjectSrcAppEnum(customFileName, fileAuthor, fileDescription) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            return [2 /*return*/, {
                    PROJECT_APP_APP: {
